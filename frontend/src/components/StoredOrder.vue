<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-title v-if="value._links">
            StoredOrder # {{value._links.self.href.split("/")[value._links.self.href.split("/").length - 1]}}
        </v-card-title >
        <v-card-title v-else>
            StoredOrder
        </v-card-title >
        ...
        <v-card-text>
            ...
            <Number label="OrderdId" v-model="value.orderdId" :editMode="editMode"/>
        ...
        methods: {
            ...
            async save(){
                try {
                    ...
                    if(!this.offline) {
                        if(this.isNew) {
                            temp = await axios.post(axios.fixUrl('/storedOrders'), this.value)
                        } else {
